...
Send-SQLCommand -command "INSERT INTO ESTUDIANTES VALUES (4, 'Leandro', 'Ruiz', 'Acuna')"
Send-SQLCommand -command "INSERT INTO ESTUDIANTES VALUES (1, 'I', 'Ramirz', 'R')"
Send-SQLCommand -command "INSERT INTO ESTUDIANTES VALUES (5, 'I', 'Ramirz', 'R')"
#Send-SQLCommand -command "INSERT INTO ESTUDIANTES VALUES (4, 'I', 'Ramirz', 'R')"
#Send-SQLCommand -command "DELETE FROM ESTUDIANTE WHERE apellido = 'Ruiz' ;"
#Send-SQLCommand -command "DELETE FROM ESTUDIANTE ;"
Send-SQLCommand -command "UPDATE ESTUDIANTE SET nombre = 'Juan' WHERE id = 1;" 
Send-SQLCommand -command "SELECT * FROM ESTUDIANTES ;"
#Send-SQLCommand -command "SELECT * FROM ESTUDIANTES WHERE apellido = 'Ramirz';  "
